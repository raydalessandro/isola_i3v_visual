# ISOLA DEI TRE VENTI — Bible di Serie

**Versione:** 2.0
**Data:** 2026-04-21
**Status:** Official Universe Specification — estesa con Fase A3
**Autore:** EAR Lab + Claude (Fase A3)
**Target:** Bambini 4-6 anni (leggibili fino a 10 come iniziazione mascherata)
**Si parla con:** `EAR_KERNEL_AILA_v1_0.md`, `MITI_FONDATORI_BREVI_v1.md`, `VOCE_AUTORE_ESTRATTA_v1_1.md`, `CARTA_VOCE_v1_2.md`, `PATTERN_AI_DA_BANDIRE_v1.md`, `STORIE_SCHEMA_v1_1.md`, `GLOSSARIO_ISOLA.md`, `RIFERIMENTI_OPERATIVI.md`

**Changelog rispetto a v1.1 in fondo al documento (§9).**

---

## §ABSTRACT

Saga di 12 storie illustrate per bambini 4-6 anni (leggibili fino ai 10 come iniziazione mascherata), ambientate sull'Isola dei Tre Venti. Tre fratelli umani (Gabriel, Elias, Noah) protagonisti, mondo abitato da animali antropomorfizzati. Framework EAR (Δ Distinguere / ⇄ Connettere / ⟳ Cambiare) come architettura silente, mai nominato nel testo. Cosmogonia in due epoche: Mitica (libro 0, raccontato esplicitamente — Spiriti Ariete/Ondina/Tempesta che creano l'isola e si trasformano in Venti) e Presente (libri 1-12, dove i Venti sono presenze costanti ma invisibili).

Saga 12 storie = 4 cicli da 3 storie (Δ-dominante, ⇄-dominante, ⟳-dominante, integrato), copre 1 anno completo dell'isola con sfasamento stagionale (vedi §8.7). Continuità tipo Pokémon (accumulo, conseguenze, evoluzione).

---

## §1. COSMOGONIA

### §1.1 Struttura temporale

**Due epoche:**

- **Epoca Mitica** (Libro 0 — Miti Fondatori): tempo delle origini. Spiriti Fondatori visibili, hanno corpo, parlano, agiscono, creano l'isola. A fine Mito 3 si trasformano in Venti.

- **Epoca Presente** (Libri 1-12 — Avventure dei Fratelli): tempo delle storie. Spiriti non più visibili. Venti sempre presenti. Fratelli protagonisti.

### §1.2 Spiriti Fondatori (canonici Bible v1.1)

Esistono solo nei miti. Creature primordiali. Dopo creazione si trasformano in Venti.

**Ariete** ≡ Δ incarnato. Ariete (la specie). Quattro zampe, due corna, occhi seri. Voce: BEEEE! Funzione: separa le cose. Domanda: "Tu chi sei? Da cosa sei diverso?"

**Ondina** ≡ ⇄ incarnata. Lontra. Snella, baffi lunghi, coda veloce, occhi dolci. Voce: canta come ruscello. Funzione: collega le cose. Domanda: "A chi sei collegato? Chi vuoi incontrare?"

**Tempesta** ≡ ⟳ incarnata. Gufo enorme. Occhi come luna, ali enormi, piume grigie. Voce: UUUUUH! + WHOOOOSH! Funzione: cambia le cose. Domanda: "Cosa devi lasciare andare? Cosa vuoi diventare?"

### §1.3 Trasformazione in Venti (canonico Bible v1.1)

Dopo creazione completa, gli Spiriti decidono di ritirarsi: "siamo troppo grandi, faremmo paura". Si trasformano in Venti — presenza costante ma non spaventosa.

| Spirito | Vento | Momento | Effetto |
|---------|-------|---------|---------|
| Ariete | Vento Taglio | alba | rende nitido |
| Ondina | Vento Intreccio | giorno | porta notizie |
| Tempesta | Vento Mulinello | sera | cambia tutto |

Da quella notte: Spiriti non più visti. Venti sempre sentiti. Gli abitanti sanno (per tradizione orale) che gli Spiriti sono nei Venti.

### §1.4 Testimone della trasformazione (NUOVO in v2.0)

**Principio cosmologico aggiunto in Fase A3.**

Tra gli abitanti dell'isola attuale, **una sola figura ha conosciuto gli Spiriti dal vivo prima della trasformazione in Venti**: lo stambecco verde **Grunto**, che vive nel Burrone tra le Montagne Gemelle.

Grunto è ponte unico tra Epoca Mitica ed Epoca Presente. Era già sull'isola quando gli Spiriti erano Spiriti. Si è ritirato in alto perché abituato a una densità di presenza che il vento-respiro attuale non gli basta più (lassù il vento è ancora un poco più pieno).

**Vincoli operativi della memoria pre-Vento di Grunto:**

- Mai pronuncia i nomi propri Ariete/Ondina/Tempesta — quei nomi sono del libro 0
- Mai un racconto pieno di una scena pre-Vento — solo frammenti incompiuti
- Mai un Grunto nostalgico che vorrebbe il passato — sta in alto per scelta, non per lutto
- Quota saga: massimo 2 frammenti di memoria pre-Vento in tutta la saga, da tracciare in `QUOTE_TRACKER.md`
- Architrave dello strato 3 (rilettura adulta), non superficie da spiegare

Nessun altro abitante della saga ha conosciuto gli Spiriti dal vivo. Tutti gli altri sono *abitanti dopo*. Solo Grunto è *abitante prima*.

### §1.5 La notte come spazio non mitico (NUOVO in v2.0)

La notte dell'isola è quando i tre venti dormono. È spazio silenzioso, ferma, non abitata da spiriti.

**Non c'è un quarto vento. Non c'è uno Spirito della Notte.** La notte non è personificata né sacralizzata: è ambiente naturale, non agente.

Le scene notturne sono rare in saga (massimo 3-4 in tutta la saga), in posizione strutturale, e hanno peso. Quando ci sono, il narratore-iniziato (Tratto 14) ha agio maggiore.

---

## §2. PROTAGONISTI

### §2.1 Struttura familiare (canonico Bible v1.1)

I tre fratelli sono **umani**, gli unici umani dell'isola. Tutti gli altri abitanti sono animali antropomorfizzati (parlano, hanno mani, vivono in case, ecc.). Questa distinzione ontologica è silenziosa — mai spiegata nel testo, accettata come dato del mondo dal bambino di 4 anni, comincia a interrogarsi nel bambino di 9.

I genitori dei fratelli **non sono mai citati** nelle 12 storie. Non assenti né morti — semplicemente fuori scena. Diversi abitanti dell'isola assumono ruoli familiari surrogati per episodi (vedi §4 — "ruolo familiare episodico" in ogni scheda). Mai lo stesso abitante due volte di fila nello stesso ruolo.

P6 (inseparabilità): ogni storia richiede tutti e tre i fratelli. Nessuno da solo risolve.
...
**Voce:** frasi più piene, qualche verbo riflessivo, propensione al "forse" e al "non so". Quando si decide è netto.

**Paura nascosta:** perdere i fratelli. Non fisicamente — che cresceranno e saranno diversi. Mai detta esplicitamente. Sviluppo emotivo previsto: storie 9 e 12.
...
**Voce:** frasi che aprono ad altri ("Possiamo...", "E se..."). Cita altri personaggi, ricorda cose dette.

**Paura nascosta:** non essere abbastanza — Gabriel è profondo, Noah è speciale perché piccolo, "e io? quello in mezzo". Mai detta. Sviluppo emotivo previsto: storia 11.
...
**Voce:** frasi spezzate, esclamative, percezione fisica al primo posto. Ripete parole.

**Paura nascosta:** il buio. Non lo ammette. Di notte si avvicina ai fratelli senza dire niente. Sviluppo emotivo previsto: storia 10.

### §2.5 Dinamiche tra fratelli (canonico Bible v1.1)

- Gabriel ↔ Elias: rispetto reciproco, si completano naturalmente
- Gabriel ↔ Noah: protezione, litigano spesso (grande vs piccolo), Gabriel sposta coperta di notte, Noah cerca Gabriel nel buio
- Elias ↔ Noah: complicità nel fare, Elias segue Noah nelle esplorazioni e poi sistema i guai

Tutti e tre inseparabili (P6 incarnato). Ogni storia li richiede tutti e tre.

---

## §3. LUOGO

Vedi §8 — ATLANTE DELL'ISOLA per descrizione geografica completa. Riepilogo:

L'isola misura ~8×7 km. Strutturata in tre cinture concentriche: mare → fascia costiera (500-800m) → Fiume che Gira (anello quasi chiuso) → terra interna. Quattro quartieri cardinali nella terra interna: Fuoco (est), Acqua (sud), Terra (ovest), Aria (nord). Centro: Villaggio con Albero Vecchio. Mandala silenzioso, mai nominato come tale.

I Tre Venti soffiano in tre tempi della giornata (Taglio all'alba, Intreccio di giorno, Mulinello la sera). La notte è spazio silenzioso non mitico (vedi §1.5).

Anno = 4 stagioni canoniche (primavera, estate, autunno, inverno). Saga = 12 storie sfasate sulle stagioni (vedi §8.7).

---

## §4. ABITANTI

### §4.1 Principi (espansi in v2.0)

Animali antropomorfizzati. Parlano italiano standard, hanno mani, vivono in case. Personaggi vivi con difetti, mai funzioni narrative pure (cfr. Spencer + Luo richiamati in v1.1).

**Distinzione critica:**

- **Spiriti** = forze primordiali, solo nei miti (libro 0). Mai nominati come Spiriti dai personaggi delle storie 1-12.
- **Abitanti dopo** = animali che vivono sull'isola. Conoscono leggende sugli Spiriti per tradizione orale. Non li hanno mai visti.
- **Abitante prima** = uno solo: Grunto (vedi §1.4).

**Regola operativa fondamentale per le schede personaggio (Tratto 7 — astrazione incarnata):**

Ogni personaggio incarna la propria qualità in *azioni*, non in descrizioni. Test: togliendo il nome, descrivendo solo cosa fa, il nome deve essere ricostruibile dall'azione. Se un personaggio non incarna la sua qualità in azione, non entra.

**Regola operativa per i nomi (Tratto 12 — nominazione operativa):**

Ogni nome deve fare almeno una di queste tre cose: contenere già la qualità, posizionare nel mondo, fissare un'azione ricorrente. Le etichette pure sono ammesse solo per personaggi non-funzionali.

### §4.2 Cast complessivo

**Tre fratelli al centro** (Gabriel, Elias, Noah — vedi §2).

**Cinque abitanti maggiori** (presenti attivi in 4 storie max ciascuno, sfondo o nominati in altre): Bartolo, Fiamma, Rovo, Stria, Mèmolo.

**Una figura di confronto:** Grunto.

**Quattro abitanti minori-mestieri** (presenti episodici in 2-3 storie ciascuno): Salvia, Nodo, Amo, Zolla.

**Cinque cuccioli** compagni di scuola dei tre fratelli (la scuola di Stria è frequentata anche dai tre fratelli — convenzione: i cuccioli sono come una diversa etnia, parlano normale, nessuna differenza linguistica): Pun, Toba, Bru, Cardo, Liù.

**Quattro gruppi-istituzioni** che popolano l'isola e ne fanno funzionare la civiltà: Coltivatori del Cerchio, Mercato del Mezzogiorno, Mantenitori, Camminanti.

**Cast totale nominato:** 19 abitanti individuali + 4 gruppi-istituzioni + 3 fratelli = pieno, vario, Pokémon-friendly.
...
Modalità chiacchiera (in casa, mentre lavora):
- *"Eh dove andate stamattina, alle Montagne? Bene bene. Portate una pagnotta a Grunto da parte mia. No, due — una se la mangia in cammino..."*

Modalità ferma (quando la cosa si fa seria):
- *"Vieni qui."*
- *"Hai mangiato?"*
...
**Detti popolari (NUOVO in v2.0).** Fiamma in modalità chiacchiera può portare detti brevi e ritmici — saggezza popolare diffusa, mai morale della storia presente. Embedded nel flusso parlato, en passant, mai in posizione strutturale. Esempio: *"Eh ma si sa, fuoco caldo non teme vento freddo. Vuoi un cornetto?"*. Quota: massimo 2 detti per storia in cui Fiamma compare in chiacchiera. Tracciare in `QUOTE_TRACKER.md`. Vietato a Fiamma in modalità ferma o brace, vietato ad altri personaggi (firma esclusiva di Fiamma chiacchierona).
...
**Voce tipica.**
- *"Tu cosa pensi?"*
- *"In cambio voglio una storia."*
- *"L'hai detta tu."*
- *"Aspetta."*

Voce un filo più formale degli altri abitanti. Niente *"eh"*, niente *"dai"*. Frasi pulite, brevi, complete. Non rigide — calme.
...
- *"Non sei tu Gabriel? Sei Elias. Scusa. È che a quest'ora le facce mi si confondono."*

Voce-precisa (rara, una a storia se compare):
- *"La nebbia oggi viene dal basso, non dall'alto."*
...
Voce-piena (rara, una volta in qualche storia di soglia):
- *"Adesso il vento respira. Una volta camminava."*
- *"Quassù la roccia ricorda diverso. Loro c'erano stati."*

Mai una frase che spiega. Mai una frase che si scusa. Mai un *"perché"*.
...
**Voce tipica.**
- *"Qui fa male?"*
- *"Tieni questa. Una al mattino."*
- *"Camomilla. Stasera, calda."*
...
- *"Aspetta."*
- *"Non oggi. Domani."*
- (al cucciolo che ha fatto rumore) *"Hai sentito tu come ha fatto il pesce?"*
...
- *"Tre lune presto."*
- *"Adesso, prima che il vento giri."*
- *"Lascia qualcosa per dopo."*
...
**Voce tipica.**
- *"Al pozzo, papà."*
- *"Però se gira di là il vento, le foglie cadono di qua."*
- *"Aspetta, lo dico anche a Toba."*
...
- *"Perché?"*
- *"E poi?"*
- *"Forse perché... aspetta, lo penso ancora un attimo."*
...
- *"Non lo so."*
- *"Lo dico allo zio."*
- (raro, in fiducia) *"A me piace quando piove."*
...
- *"Provo io."*
- *"Sei più lento di Toba."*
- (raro, serio) *"Stai qui che ti porto dallo zio Rovo."*
...
**Voce tipica.**
- *"Ho sentito che."*
- *"Indovina chi è dal forno adesso."*
- *"Aspetta, vado a vedere."*
- (un attimo prima di sparire) *"Torno!"*
...
### §5.1 Principi generali (canonici Bible v1.1)

**Framework invisibile** (REGOLA D'ORO): Δ.⇄.⟳ mai nominati. Emergono da problema e soluzione. Bambini assorbono senza sapere.

**Personaggi vivi** (Spencer + Luo): nessun fratello "è" un attributo. Tutti mostrano tutti e tre i principi in momenti diversi.

**Tre fratelli necessari** (P6): ogni storia li richiede tutti e tre. Nessuno da solo risolve.

### §5.2 Corpus completo (canonico Bible v1.1, integrato in v2.0)

| Libro | Contenuto | Stagione apertura |
|-------|-----------|-------------------|
| 0 | I Tre Miti Fondatori | (atemporale) |
| 1-3 | Blocco A — Δ dominante | inverno → primavera |
| 4-6 | Blocco B — ⇄ dominante | primavera → estate |
| 7-9 | Blocco C — ⟳ dominante | estate → autunno |
| 10-12 | Blocco D — integrazione | autunno → inverno |

**Ciclo annuale chiuso:** la storia 12 si apre nel passaggio autunno→inverno, chiudendo l'anno e tornando alla soglia da cui è partita la storia 1.

### §5.3 Template storia (canonico Bible v1.1)

Struttura standard: 4-6 pagine fisiche, 800-1200 parole, frasi brevi, ritmo ripetitivo, frase chiave memorabile.

Sezioni: APERTURA (situazione iniziale, equilibrio) → TENSIONE (problema emerge, richiede attributo specifico) → SOGLIA (K_crit attraversata, momento critico, prima/dopo distinguibili) → RISOLUZIONE (collaborazione fratelli, ognuno contribuisce a modo suo) → CHIUSURA (nuovo equilibrio, mai morale).

10 beat visivi mappabili (vedi `CARTA_VOCE_v1_2.md` §1.5).

### §5.4 Checklist pre-scrittura (vedi CARTA_VOCE_v1_2.md §4)
...
### §7.1 Per la scrittura

- Usa questo documento come riferimento di mondo
- Ogni storia rispetta i canonici e le decisioni A3
- Spiriti mai menzionati nelle storie 1-12 (eccetto frammenti incompiuti di Grunto, vedi §1.4)
- Venti sempre presenti come sfondo (alba/giorno/sera)
- Notte come spazio silenzioso non mitico (vedi §1.5)
- Abitanti possono raccontare leggende sugli Spiriti per tradizione orale, ma mai ricostruzioni dettagliate del mito
- Per ogni nuovo nome introdotto in una storia: applicare Tratto 12 (deve fare qualcosa) e registrarlo nel `GLOSSARIO_ISOLA.md`
- Per ogni personaggio in scena: rispettare scheda di §4 (specie, residenza, voce, vincoli)
- Per consultazione veloce in scrittura: usare `RIFERIMENTI_OPERATIVI.md`

### §7.2 Per le illustrazioni (Fase E)

- I tre fratelli sono i figli di Ray (con riconoscibilità visiva costante attraverso le 12 storie)
- Le firme visive di ogni personaggio (firma fisica + capo distintivo) sono dichiarate in §4 — vanno rispettate in ogni tavola
- Gli oggetti-simbolo dei gruppi (carriola, zappa curva, scala) sono riconoscimento visivo a colpo d'occhio
- Spiriti appaiono SOLO nel Libro 0
- Mappa dell'isola va prodotta come tavola unica nel libro (vedi §8 — Atlante)

### §7.3 Per il futuro

- Universo espandibile (oltre il mare, vedi §8.8)
- Nuovi territori aggiungibili
- Nuovi abitanti possibili
- Struttura base resta
- Spiriti non tornano mai visibili
- Sviluppo post-saga del narratore previsto in Fase F (vedi `CARTA_VOCE_v1_2.md` §3.7 e `VOCE_AUTORE_ESTRATTA_v1_1.md` §6)

---

## §8. ATLANTE DELL'ISOLA

L'isola sta in mezzo al mare. Misura circa otto chilometri da est a ovest, sette da nord a sud — abbastanza grande da contenere quattro quartieri diversi, una foresta in cui si può davvero perdersi, e due montagne che richiedono mezza giornata di cammino per essere raggiunte. Abbastanza piccola perché un fratello, partendo all'alba dal Villaggio, possa arrivare ovunque sull'isola e tornare entro sera.

L'isola è strutturata in **tre cinture concentriche**.
...
Dentro il Fiume sta la **terra interna** — il cuore dell'isola, dove vive la maggior parte degli abitanti. Qui si trovano il Villaggio centrale, gli Orti del Cerchio, la Foresta Intrecciata, le pendici e le cime delle Montagne Gemelle.

L'anello del Fiume è interrotto in due punti.

A sud, **La Bocca** — un canale largo abbastanza per le barche, dove il Fiume sfocia nel mare e dove le acque dolci e salate si mescolano. Dentro La Bocca, sull'acqua mista, sta il Pontile di Bartolo. Qui le barche entrano e escono verso il mare aperto.

A nord, dove il Fiume scorre più calmo e meno profondo, **un guado di pietre piatte** — pietre grandi messe a distanza di un passo l'una dall'altra. Qui si attraversa a piedi per uscire dalla terra interna verso la fascia costiera nord. Il guado non porta alle Montagne — quelle stanno nella terra interna e si raggiungono dall'interno.
...
Distanze dal Villaggio centrale:
- Forno di Fiamma: 30 minuti
- Pontile di Bartolo: 40 minuti
- Casa di Rovo: 35 minuti
- Roccia Alta: 2 ore
- Grotta di Grunto: 4-5 ore (mezza giornata)

### §8.2 Il Quartiere di Fuoco — a est
...
### §8.3 Il Quartiere d'Acqua — a sud
...
### §8.7 La giornata e l'anno

**Quattro tempi della giornata:**

- **Alba** = Vento Taglio. Da est, taglia la nebbia, rende nitido.
- **Giorno** = Vento Intreccio. Caldo, avvolgente, porta odori e notizie.
- **Sera** = Vento Mulinello. Imprevedibile, sposta cose, cambia direzione.
- **Notte** = i tre venti dormono. L'isola è ferma. Spazio silenzioso non abitato da spiriti (vedi §1.5).

**Quattro stagioni** — primavera, estate, autunno, inverno.

**Ciclo annuale della saga (NUOVO in v2.0):**

Saga = 12 storie sfasate sulle stagioni. La saga copre esattamente un anno completo dell'isola. I cicli narrativi (Δ-⇄-⟳-integrato) e le stagioni sono *sfasati di una storia*, in modo che il cambio di ciclo non coincida mai col cambio di stagione (mandala silenzioso temporale).

| Storia | Ciclo (EAR) | Stagione (visibile) |
|--------|-------------|---------------------|
| 1 | A (Δ) | inverno |
| 2 | A (Δ) | inverno |
| 3 | A (Δ) | passaggio inverno → primavera |
| 4 | B (⇄) | primavera |
| 5 | B (⇄) | primavera |
| 6 | B (⇄) | passaggio primavera → estate |
| 7 | C (⟳) | estate |
| 8 | C (⟳) | estate |
| 9 | C (⟳) | passaggio estate → autunno |
| 10 | D (integr.) | autunno |
| 11 | D (integr.) | autunno |
| 12 | D (integr.) | passaggio autunno → inverno (anno chiuso) |

### §8.8 Quello che c'è oltre

Oltre il mare aperto c'è altro. Bartolo qualche volta traghetta verso fuori. Esce dalla Bocca al mattino e torna alla sera, o dopo un giorno o due. Dove va, gli abitanti non sanno di preciso.

Si sa che ci sono **altre terre**, altri abitanti di specie che qui non si vedono, che il mare è grande.

Non è raccontato. È una porta lasciata socchiusa per Fase F (sviluppo post-saga).

### §8.9 Zone non ancora nominate

L'isola contiene aree volutamente non descritte in dettaglio, riservandosi di nominarle se una storia le richiederà:

- **Fascia costiera nord-ovest** — spiagge piccole, scogliere basse, qualche grotta
- **Fascia costiera est** — costa selvaggia, scogliere medie, qualche grotta
- **Interno della Foresta Intrecciata** — radure profonde, alberi più antichi, tracce non battute
- **Valli alte tra le Montagne** — territorio di Grunto e di nessun altro
- **Bosco costiero a ovest** — piccolo bosco non esplorato sulla fascia costiera ovest
- **Piccole isole all'orizzonte** — visibili da Roccia Alta in giornate molto chiare a sud-est e ovest

Vanno nominate solo quando una storia le richiederà davvero, sotto Tratto 12, con la regola che ogni nome introdotto deve poi tornare in almeno un'altra storia.

---

## §9. CHANGELOG

### v2.0 (2026-04-21) — post Fase A3

**Nuovi contenuti rispetto a v1.1:**

- **§1.4 nuovo:** Testimone della trasformazione (Grunto come ponte unico tra Epoca Mitica ed Epoca Presente, vincoli operativi memoria pre-Vento)
- **§1.5 nuovo:** La notte come spazio non mitico
- **§3 riformulato:** rinvia all'Atlante §8 esteso
- **§4 espanso massicciamente:** dai 5 abitanti maggiori v1.1 (Bartolo/Fiamma/Rovo/Soffio/Mèmolo) si passa a 19 abitanti individuali nominati + 4 gruppi-istituzioni. Tutti rifatti sotto Tratto 7 (astrazione incarnata) + Tratto 12 (nominazione operativa). Ogni scheda include firma visiva, voce tipica, funzione narrativa, vincoli specifici.
- **§4 dettaglio:** Soffio (v1.1) → **Stria** (v2.0) con cambio nome al femminile + ruolo maestra. Fiamma con doppia modalità chiacchiera/ferma + detti popolari ammessi in modalità chiacchiera. Mèmolo con Pun figlio + funzione precisa. Rovo con Bru nipote (storia mai raccontata).
- **Nuovi nominati:** Grunto (figura di confronto), Salvia/Nodo/Amo/Zolla (mestieri), Pun/Toba/Bru/Cardo/Liù (cuccioli scuola).
- **Nuovi gruppi-istituzioni:** Coltivatori del Cerchio, Mercato del Mezzogiorno, Mantenitori, Camminanti.
- **Oggetti-simbolo:** carriola di vimini (Camminanti), zappa col manico curvo (Coltivatori), scala a pioli (Mantenitori). Mercato senza oggetto-simbolo (è luogo).
- **§6 palette aggiornata** con nuovi quartieri e nuovi abitanti.
- **§8 nuovo:** Atlante dell'Isola completo. Geografia: tre cinture concentriche (mare → fascia costiera 500-800m → Fiume che Gira anello quasi chiuso → terra interna). Fiume con sorgente alle Montagne, foce a La Bocca a sud, anello aperto solo a sud per drenaggio fisicamente coerente. Quattro quartieri cardinali + Villaggio centrale con Albero Vecchio (mandala silenzioso). Quattro vie nominate. Distanze e dimensioni esplicite (~8×7 km). Quattro tempi della giornata + quattro stagioni. Sfasamento stagionale dei 4 cicli narrativi. Zone bonus §8.9 per spazio narrativo riservato.
- **§7.1-7.2 aggiornate** con nuovi riferimenti operativi.

### v1.1 (2026-01-19)
Aggiunta sezione Spiriti Fondatori, chiarita relazione con Venti.

### v1.0
Versione iniziale Bible.

---

#END

*I Tre Venti soffiano sempre, anche quando non li senti.*

*La notte sull'isola, anche loro dormono.*
