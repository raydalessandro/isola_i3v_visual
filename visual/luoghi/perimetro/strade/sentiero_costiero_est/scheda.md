...
fonti: ["cartografia/geo/island.geojson#features.id=sentiero_costiero_est"]
appare_in_storie: []
cartografia:
  feature_id: sentiero_costiero_est
  type_geo: path
  status_geo: provvisorio
  quarter: perimetro
  category: sentiero_costiero
  centroid_m_local: [5407, 3629]
  bbox_m_local: [4405, 1000, 6208, 6400]
  ...
  children_geo: []
  aliases_geo: []
  lunghezza_m_local: 6834
  n_punti: 7
  endpoint_a_m: [4405, 1000]
  endpoint_b_m: [4506, 6400]
  endpoints_inferiti_dal_id: [costiero, est]
---
