...
name: Case Basse dei Pescatori
famiglia: luogo
sottotipo: building
quartiere: acqua
status: stub
ultima_modifica: 2026-04-25
fonti: ["pipeline_narrativa/story_graph.json#entities.locations.case_basse_pescatori", "cartografia/geo/island.geojson#features.id=case_basse_pescatori"]
appare_in_storie: []
cartografia:
  feature_id: case_basse_pescatori
  type_geo: building
  status_geo: canonico
  quarter: acqua
  category: fisher_house_cluster
  centroid_m_local: [3905, 1100]
  bbox_m_local: [3905, 1100, 3905, 1100]
  size_m_local: [0, 0]
  altitudine_m: null
  geometry_type: Point
  parent_geo: null
