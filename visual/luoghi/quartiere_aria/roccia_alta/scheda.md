...
fonti: ["pipeline_narrativa/story_graph.json#entities.locations.roccia_alta", "cartografia/geo/island.geojson#features.id=roccia_alta"]
appare_in_storie: []
cartografia:
  feature_id: roccia_alta
  type_geo: landmark
  status_geo: canonico
  quarter: aria
  category: null
  centroid_m_local: [4205, 5300]
  bbox_m_local: [4205, 5300, 4205, 5300]
  size_m_local: [0, 0]
  altitudine_m: 550
  geometry_type: Point
  parent_geo: null
