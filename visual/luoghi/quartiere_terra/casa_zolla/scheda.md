...
fonti: ["pipeline_narrativa/story_graph.json#entities.locations.casa_zolla", "cartografia/geo/island.geojson#features.id=casa_zolla"]
appare_in_storie: []
cartografia:
  feature_id: casa_zolla
  type_geo: burrow
  status_geo: canonico
  quarter: terra
  category: burrow_dwelling
  centroid_m_local: [2803, 3200]
  bbox_m_local: [2803, 3200, 2803, 3200]
  size_m_local: [0, 0]
  altitudine_m: null
  geometry_type: Point
  parent_geo: null
