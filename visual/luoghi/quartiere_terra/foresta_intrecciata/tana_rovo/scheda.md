...
fonti: ["pipeline_narrativa/story_graph.json#entities.locations.tana_rovo", "cartografia/geo/island.geojson#features.id=tana_rovo"]
appare_in_storie: []
cartografia:
  feature_id: tana_rovo
  type_geo: burrow
  status_geo: canonico
  quarter: terra
  category: null
  centroid_m_local: [2403, 3700]
  bbox_m_local: [2403, 3700, 2403, 3700]
  size_m_local: [0, 0]
  altitudine_m: null
  geometry_type: Point
  parent_geo: null
