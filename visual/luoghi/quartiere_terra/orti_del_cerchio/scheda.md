---
id: orti_del_cerchio
name: Orti del Cerchio
famiglia: luogo
sottotipo: fields
quartiere: terra
status: stub
ultima_modifica: 2026-04-25
fonti: ["pipeline_narrativa/story_graph.json#entities.locations.orti_del_cerchio", "cartografia/geo/island.geojson#features.id=orti_del_cerchio"]
appare_in_storie: []
cartografia:
  feature_id: orti_del_cerchio
  type_geo: fields
  status_geo: canonico
  quarter: terra
  category: null
  centroid_m_local: [3104, 3500]
  bbox_m_local: [3104, 3500, 3104, 3500]
  size_m_local: [0, 0]
  altitudine_m: null
  geometry_type: Point
  parent_geo: null
