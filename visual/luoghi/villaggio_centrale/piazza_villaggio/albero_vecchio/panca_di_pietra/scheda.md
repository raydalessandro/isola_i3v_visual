...
appare_in_storie: []
cartografia:
  feature_id: panca_di_pietra
  type_geo: landmark
  status_geo: canonico
  quarter: centro
  category: null
  centroid_m_local: [4007, 3497]
  bbox_m_local: [4007, 3497, 4007, 3497]
  size_m_local: [0, 0]
  altitudine_m: null
  geometry_type: Point
  parent_geo: null
  children_geo: []
  aliases_geo: [mercato_del_mezzogiorno_panca_di_pietra]
---
