# Prompt Flux/Grok — `gabriel`

**Versione:** 1.0
**Data:** 2026-04-30
**Scopo:** generare le illustrazioni canoniche di riferimento del personaggio Gabriel. Queste immagini fissano l'aspetto canonico per tutte le illustrazioni successive nelle 12 storie. **Generare 4 immagini in sequenza** — la stylesheet canonica deve essere identica in tutte e 4. **Gabriel è ANCHOR DI SCALA della saga (1.0 GU)** — le sue immagini sono particolarmente importanti perché serviranno da reference per dimensionare tutti gli altri personaggi.
...
realism. The three human siblings (Gabriel, Elias, Noah) are the only
humans on the island and share this same painterly style — naturalistic
human anatomy, slightly stylized for warmth, never cartoon-flat.

Eyes are alive but never huge anime-style; never disney-cute with
exaggerated lashes.
...
## 📐 CANONE PERSONAGGIO — Gabriel (riusare in TUTTI i prompt di Gabriel)

Questo blocco descrive il canone fisso di Gabriel. Va riusato in ogni prompt che lo include, in tutte le 12 storie.
