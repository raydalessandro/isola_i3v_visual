...
**Versione:** 1.0
**Data:** 2026-04-30
**Scopo:** generare le illustrazioni canoniche di riferimento del personaggio Stria. **Generare 4 immagini in sequenza** — la stylesheet canonica deve essere identica in tutte e 4. Statura: alta, ~1.0-1.1 GU sulla scala saga (l'airone è alto in proporzione, vicino a Gabriel come altezza ma molto più magro).
